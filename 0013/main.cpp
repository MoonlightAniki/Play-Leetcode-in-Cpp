...
simply X + II. The number twenty seven is written as XXVII, which is XX + V + II.Roman numerals are usually written
...
// Runtime: 48 ms, faster than 91.55% of C++ online submissions for Roman to Integer.